...
using KochmarLab1.Annotations;

namespace KochmarLab1
{
    class Main : INotifyPropertyChanged
    {
        ...
        private string _westernZodiacResult;
        private string _chineseZodiacResult;
        ...
        {
            get => $"Western zodiac: {_westernZodiacResult}";
            set
            {
                _westernZodiacResult = value;
                OnPropertyChanged();
            }
        }
        ...
        {
            get => $"Chinese zodiac: {_chineseZodiacResult}";
            set
            {
                _chineseZodiacResult = value;
                OnPropertyChanged();
            }
        }

        #region WesternZodiacCounting
            ...
            await Task.Run(() =>
                {
                    ...
                    WesternZodiac = WesternZodiacCount();
